package io.github.ccqstark.qrpc.core.registry.zk.util;

import io.github.ccqstark.qrpc.common.enums.RpcConfigEnum;
import io.github.ccqstark.qrpc.common.utils.PropertiesFileUtil;
    ...
    public static void createPersistentNode(CuratorFramework zkClient, String path) {
        try {
            if (REGISTERED_PATH_SET.contains(path) || zkClient.checkExists().forPath(path) != null) {
                ...
                // 示例：/qrpc/io.github.ccqstark.HelloService/127.0.0.1:9999
